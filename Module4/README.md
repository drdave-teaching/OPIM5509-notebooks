...
| 3b | **Univariate Temperature — RNN, Part 2** | *Reload and reuse:* download the saved LSTM, prove it, occlusion by lag, then the autoregressive roll-forward scored by horizon against persistence and climatology | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module4/Univariate_Temperature_RNN_pt2.ipynb) |
| 3c | **Gradient Saliency, by Hand** | *The other way to ask what the model looks at:* signed gradients on one window, then the honesty check — add a real +1 °C and see whether the forecast moved the way the gradient promised — then all 364 windows as a heatmap | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module4/Gradient_Saliency_by_Hand.ipynb) |
| 5b | **Multivariate Occupancy — RNN, Part 2** | *Unseen data:* reload the classifier, score the third UCI file it never saw, permutation by sensor (it's a light detector), occlusion by minute, CO₂/light what-ifs | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module4/Multivariate_Occupancy_RNN_pt2.ipynb) |
| 10b | **Forecasting Electricity Demand — Part 2** | *The year the data changed:* reload the day-ahead model + scaler, forecast 2020 month by month (the lockdown shows up), the autoregressive roll-forward on unseen data, permutation importance | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module4/Forecasting_Electricity_Demand_RNN_pt2.ipynb) |
