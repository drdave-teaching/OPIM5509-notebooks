...
| 2 | **RNNs By Hand** | SimpleRNN → LSTM → GRU with a pencil: one parameter formula for every cell, `output = units`, and `check()` asserting your arithmetic against Keras layer by layer. **Examples 1–7 are M4.1; the stacking section (8–11) is M4.2** | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module4/RNNs_By_Hand_basic.ipynb) |
