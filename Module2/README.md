...
| — | *Titanic done right (train/val/test)* | Three piles, three jobs — `validation_data` vs `validation_split`, stratify, and the one number you're allowed to report | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module2/0b_BinaryClassification_Titanic_TrainValTest.ipynb) |
| — | *Titanic k-fold* | Five honest scores instead of one lottery ticket — fresh model every fold, mean ± std, the leakage experiment | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/drdave-teaching/OPIM5509-notebooks/blob/main/Module2/0c_BinaryClassification_Titanic_KFold.ipynb) |
